...
import { Menu, Calendar, Download, CalendarPlus, ChevronLeft, ChevronRight, Moon, Sun, BarChart2 } from './icons';
...
const Header: React.FC<HeaderProps> = ({ onSetView, onResetToDefault, onExportToCSV, onExportToICS, selectedWeek, onSetSelectedWeek, onShowAnalytics }) => {
