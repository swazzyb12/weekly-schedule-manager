...
export const TEMPLATES: Partial<ScheduleItem>[] = [
  { category: 'gym', activity: 'Gym Workout', duration: '1h 30m', notes: 'Focus on form' },
  { category: 'deepwork', activity: 'Deep Work Session', duration: '2h', notes: 'No distractions' },
  { category: 'school', activity: 'Study Block', duration: '1h', notes: 'Review notes' },
  { category: 'maintenance', activity: 'Meal Prep', duration: '1h', notes: 'Cook for the week' },
  { category: 'recovery', activity: 'Reading', duration: '30m', notes: 'Relaxation' },
];